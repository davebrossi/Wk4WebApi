...
class FetchJeepTest {
  ...
  class TestsThatDoNotPolluteTheApplicationContext extends FetchJeepTestSupport {
    ...
    void testThatJeepsAreReturnedWhenAValidModelAndTrimAreSupplied() {
      ...
      String trim = "Sport";
      String uri =
          String.format("http://localhost:%d/jeeps?model=%s&trim=%s", getBaseUriForJeeps(), model, trim);
  ...
  static Stream<Arguments> parametersForInvalidInput() {
    // @formatter:off
    return Stream
        .of(arguments("WRANGLER", "asdfasdf", "Trim contains non-alphanumeric characters"),
